...
<div class="container-fluid">
    <form action="" id="signup-frm">
        ...
        <button class="button btn btn-primary btn-sm">Đăng kí</button>
        <button class="button btn btn-secondary btn-sm" type="button" data-dismiss="modal">Hủy</button>
...
div#menu-field img,
div#menu-field .menu-item-details {
    margin: auto;
    max-height: 70vh;
...
.portfolio-box .project-name:hover {
    color: white;
...
.portfolio-box {
    margin: 1em;
    border-radius: 1em;
    border: 1px solid #0053ffad;
    cursor: pointer;

}

.portfolio-box .port-content {
    opacity: 0;
...
#mainNav.navbar-scrolled .navbar-brand a:hover {
    color: white !important;
}
